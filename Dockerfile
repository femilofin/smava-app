...
# Ref: https://github.com/anapsix/docker-alpine-java
LABEL maintainer=oluwafemi.olofintuyi@gmail.com
...
RUN set -ex && \
    ...
    mkdir /tmp/dcevm && \
    curl -L -o /tmp/dcevm/DCEVM-light-8u181-installer.jar "https://github.com/dcevm/dcevm/releases/download/light-jdk8u181/DCEVM-8u181-installer.jar" && \
    mkdir /opt && \
    ...
    cd /tmp/dcevm && \
    unzip DCEVM-light-8u181-installer.jar && \
...
COPY config/helloworld.war /code
